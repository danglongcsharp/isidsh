	...
	<div class="header_section affix-top transition">
		<div class="container" id="header">
			...
			<div class="row ">
				...
				<?php } ?>
				<div class="col-md-3 col-sm-12 user_profile_div">
				<?php
if ( is_user_logged_in() ) {
	$current_user = wp_get_current_user();
	 echo 'Welcome, '.$current_user->user_nicename.' '. $current_user->user_firstname.' '.$current_user->user_lastname;
...
?>
				...
				<!-- Navigation  menus -->
	<div class="col-md-9 navigation_menu transition"  data-spy="affix" data-offset-top="95" id="enigma_nav_top">
